...
const FraudDetector = (): JSX.Element => {
    ...
    return (
        <>
            <NavBar />
            <h1 className="font-bebas-neue text-center pt-8 text-2xl font-black flex flex-col leading-none text-gray-800">
                Scotia Fraud Risk Detector
            </h1>
            {showContent && (
                <div className=" flex flex-col relative z-20 text-center items-center overflow-hidden ">

                    <div className="container mx-auto px-6 flex flex-col items-center text-center relative pb-12">
                    ...
                    <button onClick={handleSubmit} className="bg-transparent my-6 hover:bg-[#ff0000] text-black font-semibold hover:text-white py-2 px-4 border border-[#ff0000] hover:border-transparent rounded">
                        Submit
                    </button>
                </div>
            )}
            ...
            {showSpinner && (
                <div className='boxContainer center flex justify-center my-12'>
                    <div role="status">
            ...
            {showResult && (
                <div className="bg-white flex flex-col relative z-20  items-center overflow-hidden ">
                    ...
                    <button onClick={handleGoBack} className="bg-transparent my-6 hover:bg-[#ff0000] text-black font-semibold hover:text-white py-2 px-4 border border-[#ff0000] hover:border-transparent rounded">
                        Back To Detector
                    </button>
                </div>
            )}
